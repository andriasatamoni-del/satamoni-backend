...
// GET /api/purchases?branchId=&date=
...
router.post("/", requireAuth, canManage, async (req, res) => {
  const { branchId, businessDate, category, amount, fromKitchen = false, notes } = req.body;
  ...
  try {
    const result = await pool.query(
      `INSERT INTO purchases (branch_id, business_date, category, amount, from_kitchen, notes)
       VALUES ($1, $2, $3, $4, $5, $6) RETURNING *`,
      [branchId, businessDate, category || null, amount, fromKitchen, notes || null]
    );
